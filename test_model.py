...
config_testing = {
             ...
             'stride_testing': int(4.096*F_SAMPLING_TESTING )//4 ,
             'batch_size':32,
}
...
def test_model(gen, sig_model):
        ...
        while not finished:
            ...
            if finished:
                ...
                for v in range(Y_batch.shape[0]):
                    ...
                    ensemble_avg_target, ensemble_beats_target = signal_processing_modules.get_ensemble_avg(r_peaks,Y_batch[v,:],n_samples=500,upsample_factor=1)
                    ...
                    ensemble_avg_estimate, ensemble_beats_estimate = signal_processing_modules.get_ensemble_avg(r_peaks,Y_batch_predicted[v, :], n_samples=500, upsample_factor=1)
    ...
    return list_pearson_r_loss, list_subject_ids, list_i_errors, list_j_errors, list_k_errors


#run testing
list_pearson_r_loss, list_subject_ids, list_i_errors, list_j_errors, list_k_errors = test_model(test_gen, sig_model)
